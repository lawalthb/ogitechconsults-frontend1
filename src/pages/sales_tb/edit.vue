                        ...
                        <div class="col-12 col-md-auto " >
                            <div class="" >
                                <div class="row  items-center q-col-gutter-sm q-px-sm">
                                    <div class="col">
                                        <div class="text-h6 text-primary">Edit Sales Tb</div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
	...
	export default {
		...
		props: {
			...
			routeName: {
				type: String,
				default: 'sales_tbedit',
			},
			pagePath: {
				type : String,
				default : 'sales_tb/edit',
			},
			apiPath: {
				type: String,
				default: 'sales_tb/edit',
		...
		methods: {
			...mapActions('sales_tb', ['updateRecord', 'fetchRecord']),
