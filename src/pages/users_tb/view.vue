                        ...
                        <div class="col-12 col-md-auto " >
                            <div class="" >
                                <div class="row  items-center q-col-gutter-sm q-px-sm">
                                    <div class="col">
                                        <div class="text-h6 text-primary">Users Tb Details</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="col">
                                                ...
                                                <q-item>
                                                    <q-item-section>
                                                        ...
                                                        <q-item-label class="text-bold">{{ item.reg_date  | humanDate}}</q-item-label>
                                                    </q-item-section>
                                                </q-item>
                                                <q-separator></q-separator>
                                                <q-item>
                                                    ...
                                                    <q-btn icon="menu" padding="xs" round flat color="grey">
                                                        <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                            <q-list dense rounded nav>
                                                                <q-item link clickable v-ripple :to="`/users_tb/edit/${item.user_id}`">
                                                                    <q-item-section>
...
<script>
	...
	export default {
		...
		props: {
			...
			routeName : {
				type : String,
				default : 'users_tbview',
			},
			pagePath: {
				type : String,
				default : 'users_tb/view',
			},
			apiPath: {
				type : String,
				default : 'users_tb/view',
		...
		methods: {
			...mapActions("users_tb", [ "fetchRecord", "deleteRecord"]),
		},
		watch: {
			$route (to, from){
