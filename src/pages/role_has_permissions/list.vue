                        ...
                        <div class="col-12 col-md-auto " >
                            <div class="" >
                                <div class="row  items-center q-col-gutter-sm q-px-sm">
                                    <div class="col">
                                        <div class="text-h6 text-primary">Role Has Permissions</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-auto col-12 " >
                            <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/role_has_permissions/add`" class="full-width" >
                            ...
                            <div >
                                <template v-if="showBreadcrumbs && $route.query.tag">
                                    <q-breadcrumbs class="q-pa-md">
                                        <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="$route.query.tag" to="/role_has_permissions"></q-breadcrumbs-el>
                                    ...
                                    <div class="row q-col-gutter-x-md">
                                        ...
                                        <div class="col">
                                            ...
                                            <template >
                                                ...
                                                :bordered="false"
                                                :columns="$menus.Role_Has_PermissionsTableHeaderItems" 
                                                :data="records"
                                                binary-state-sort
                                                                ...
                                                                <q-btn icon="menu" padding="xs" round flat color="grey">
                                                                    <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                                        <q-list dense rounded nav>
                                                                            <q-item link clickable v-ripple :to="`/role_has_permissions/view/${props.row.permission_id}`">
                                                                                <q-item-section>
                                                                                    <q-icon color="primary"  size="sm" name="visibility"></q-icon>
                                                                                </q-item-section>
                                                                                <q-item-section>View</q-item-section>
                                                                            </q-item>
                                                                            <q-item link clickable v-ripple :to="`/role_has_permissions/edit/${props.row.permission_id}`">
                                                                                <q-item-section>
...
<script>
	...
	export default {
		name: 'listRolehaspermissionsPage',
		components: {
        },
		...
		props: {
			...
			routeName : {
				type : String,
				default : 'role_has_permissionslist',
			},
			apiPath : {
				type : String,
				default : 'role_has_permissions/index',
			},
			multiCheckbox: {
				type: Boolean,
				default: true,
		...
		computed: {
			...
			records: {
				get: function () {
					return this.$store.getters["role_has_permissions/records"];
				},
				set: function (value) {
					this.$store.commit("role_has_permissions/setRecords", value);
				},
			},
			currentRecord: {
				get: function () {
		...
		methods: {
			...mapActions("role_has_permissions", ["fetchRecords", "deleteRecord"]),
			load: function() {
				if (!this.loading) {
					this.loading = true;
