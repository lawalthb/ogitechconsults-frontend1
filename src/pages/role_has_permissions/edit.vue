                        ...
                        <div class="col-12 col-md-auto " >
                            <div class="" >
                                <div class="row  items-center q-col-gutter-sm q-px-sm">
                                    <div class="col">
                                        <div class="text-h6 text-primary">Edit Role Has Permissions</div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
	...
	export default {
		name: 'editRolehaspermissionsPage',
		components: {
		},
		...
		props: {
			...
			routeName: {
				type: String,
				default: 'role_has_permissionsedit',
			},
			pagePath: {
				type : String,
				default : 'role_has_permissions/edit',
			},
			apiPath: {
				type: String,
				default: 'role_has_permissions/edit',
		...
		computed: {
			pageTitle:{
				get: function () {
					return "Edit Role Has Permissions"
				}
			},
			currentRecord: {
				get: function () {
		...
		methods: {
			...mapActions('role_has_permissions', ['updateRecord', 'fetchRecord']),
