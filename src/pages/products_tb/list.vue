                                                ...
                                                <template v-slot:body="props">
                                                    <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                                        ...
                                                        <q-td  key="product_id" :props="props">
                                                            <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/products_tb/view/${props.row.product_id}`">{{ props.row.product_id }}</q-btn>
                                                        </q-td>
                                                        ...
                                                        <q-td  key="sell_rate" :props="props">
                                                            {{ props.row.sell_rate }}
                                                        </q-td>
                                                        <q-td  key="purchase_rate" :props="props">
                                                            {{ props.row.purchase_rate }}
                                                        </q-td>
                                                        ...
                                                        <q-td  key="available_for" :props="props">
                                                            {{ props.row.available_for }}
                                                        </q-td>
                                                        <q-td  key="admin_id" :props="props">
                                                            {{ props.row.admin_id }}
                                                        </q-td>
                                                        <q-td  key="vendor_email" :props="props">
                                                            <q-btn padding="xs"   flat :rounded="false"  size=""  color="primary"  no-caps  unelevated   type="a" :href="'mailto:' + props.row.vendor_email">{{ props.row.vendor_email }}</q-btn>
                                                        </q-td>
