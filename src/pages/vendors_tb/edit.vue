                        ...
                        <div class="col-12 col-md-auto " >
                            <div class="" >
                                <div class="row  items-center q-col-gutter-sm q-px-sm">
                                    <div class="col">
                                        <div class="text-h6 text-primary">Edit Vendors Tb</div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
	...
	export default {
		...
		props: {
			...
			routeName: {
				type: String,
				default: 'vendors_tbedit',
			},
			pagePath: {
				type : String,
				default : 'vendors_tb/edit',
			},
			apiPath: {
				type: String,
				default: 'vendors_tb/edit',
		...
		methods: {
			...mapActions('vendors_tb', ['updateRecord', 'fetchRecord']),
