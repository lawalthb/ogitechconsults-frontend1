                        ...
                        <div class="col-12 col-md-auto " >
                            <div class="" >
                                <div class="row  items-center q-col-gutter-sm q-px-sm">
                                    <div class="col">
                                        <div class="text-h6 text-primary">Vendors Tb Details</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="col">
                                                <q-item>
                                                    <q-item-section>
                                                        ...
                                                        <q-item-label class="text-bold">{{ item.vendor_id }}</q-item-label>
                                                    </q-item-section>
                                                </q-item>
                                                    ...
                                                    <q-btn icon="menu" padding="xs" round flat color="grey">
                                                        <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                            <q-list dense rounded nav>
                                                                <q-item link clickable v-ripple :to="`/vendors_tb/edit/${item.vendor_id}`">
                                                                    <q-item-section>
                                                                        <q-icon color="positive"  size="sm" name="edit"></q-icon>
                                                                    </q-item-section>
                                                                    <q-item-section>Edit</q-item-section>
                                                                </q-item>
                                                                <q-item link clickable v-ripple @click="deleteItem(item.vendor_id)">
                                                                    <q-item-section>
...
<script>
	...
	export default {
		...
		props: {
			...
			routeName : {
				type : String,
				default : 'vendors_tbview',
			},
			pagePath: {
				type : String,
				default : 'vendors_tb/view',
			},
			apiPath: {
				type : String,
				default : 'vendors_tb/view',
		...
		methods: {
			...mapActions("vendors_tb", [ "fetchRecord", "deleteRecord"]),
		},
		watch: {
			$route (to, from){
