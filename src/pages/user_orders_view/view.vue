                        ...
                        <div class="col-12 col-md-auto " >
                            <div class="" >
                                <div class="row  items-center q-col-gutter-sm q-px-sm">
                                    <div class="col">
                                        <div class="text-h6 text-primary">User Orders View Details</div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
	...
	export default {
		...
		props: {
			...
			routeName : {
				type : String,
				default : 'user_orders_viewview',
			},
			pagePath: {
				type : String,
				default : 'user_orders_view/view',
			},
			apiPath: {
				type : String,
				default : 'user_orders_view/view',
		...
		computed: {
			pageTitle:{
				get: function () {
					return "User Orders View Details"
				}
			},
			currentRecord: {
				get: function () {
		...
		methods: {
			...mapActions("user_orders_view", [ "fetchRecord", "deleteRecord"]),
		},
		watch: {
			$route (to, from){
